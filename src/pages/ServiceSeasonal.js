...
const galleryImages = [
  {
    id: 1,
    src: "assets/images/Portfolio-detail/seasonal1.jpg",
    alt: "Seasonal service 1",
    gridClass: "col-lg-4 col-md-4 col-sm-4 col-xs-6",
  },
  {
    id: 2,
    src: "assets/images/Portfolio-detail/seasonal4.jpg",
    alt: "Seasonal service 4",
    gridClass: "col-lg-8 col-md-8 col-sm-8 col-xs-6",
  },
  {
    id: 3,
    src: "assets/images/Portfolio-detail/seasonal2.jpg",
    alt: "Seasonal service 2",
    gridClass: "col-lg-4 col-md-4 col-sm-4 col-xs-6",
  },
  {
    id: 4,
    src: "assets/images/Portfolio-detail/seasonal3.jpg",
    alt: "Seasonal service 3",
    gridClass: "col-lg-4 col-md-4 col-sm-4 col-xs-6",
  },
];
      ...
      <section className="main-content-section">
        <div className="container">
          ...
          <div className="service-description">
            <h6>
              Landscapes require different care throughout the year and we have many services available to extend their life and help them continue to thrive for a long time.
            </h6>
            <p>
              From snow and ice management on commercial sites, to seasonal clean-ups, we can handle it all.
            </p>
            <p>Here are some services we can offer for you:</p>
            <ul className="service-list">
              {seasonalServices.map((service, index) => (
                <li key={index}>
                  <Link to={`/services/seasonal#${service.toLowerCase().replace(/\s+/g, "-")}`}>
                    {service}
                  </Link>
                </li>
              ))}
...
export default ServiceSeasonal; 