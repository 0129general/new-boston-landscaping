...
const galleryImages = [
  {
    id: 1,
    src: "assets/images/Portfolio-detail/masonry1.jpg",
    alt: "Masonry project 1",
    gridClass: "col-lg-4 col-md-4 col-sm-4 col-xs-6",
  },
  {
    id: 2,
    src: "assets/images/Portfolio-detail/masonry4.jpg",
    alt: "Masonry project 4",
    gridClass: "col-lg-8 col-md-8 col-sm-8 col-xs-6",
  },
  {
    id: 3,
    src: "assets/images/Portfolio-detail/masonry2.jpg",
    alt: "Masonry project 2",
    gridClass: "col-lg-4 col-md-4 col-sm-4 col-xs-6",
  },
  {
    id: 4,
    src: "assets/images/Portfolio-detail/masonry3.jpg",
    alt: "Masonry project 3",
    gridClass: "col-lg-4 col-md-4 col-sm-4 col-xs-6",
  },
];

const masonryServices = [
  "Building decorative or retaining stone walls",
  "Installing paving stone or asphalt driveways",
  "Building fire or barbecue pits",
  "Installing patios for your yard or pool area",
  "Creating walkways from paver, brick or stone",
];
...
const ServiceMasonry = () => {
  ...
  const prevSlide = () => {
    setCurrentSlide((prev) => 
      prev === 0 ? relatedProjects.length - slidesVisible : prev - 1
    );
  };
      ...
      <section className="main-content-section">
        <div className="container">
          ...
          <div className="service-description">
            <h6>
              The exterior of your home is the first thing people see when arriving for a visit - is it making a good first impression?
            </h6>
            <p>
              Keep your home looking beautiful and your visitors wowed by updating the exterior with beautiful masonry!
            </p>
            <p>Here are some services we can offer for you:</p>
            <ul className="service-list">
              {masonryServices.map((service, index) => (
                <li key={index}>
                  <Link to={`/services/masonry#${service.toLowerCase().replace(/\s+/g, "-")}`}>
                    {service}
                  </Link>
                </li>
              ))}
